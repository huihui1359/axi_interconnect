...
module stage1_unit_tb;

  import uvm_pkg::*;
  import axi_types_pkg::*;
  import axi_env_pkg::*;
  import axi_seq_pkg::*;
  import stage1_unit_test_pkg::*;
  ...
  initial begin
    uvm_config_db#(m_master_vif_t)::set(
      null, "uvm_test_top", "m_master_vif", m_if
    );
    uvm_config_db#(m_slave_vif_t)::set(
      null, "uvm_test_top", "m_slave_vif", m_if
    );
    uvm_config_db#(m_mon_vif_t)::set(
      null, "uvm_test_top", "m_mon_vif", m_if
    );
    uvm_config_db#(s_master_vif_t)::set(
      null, "uvm_test_top", "s_master_vif", s_if
    );
    uvm_config_db#(s_slave_vif_t)::set(
      null, "uvm_test_top", "s_slave_vif", s_if
    );
    ...
    // UVM 1.1d stores this value in the simulator precision unit.
    uvm_root::get().set_timeout(1_000_000, 1'b1);
    run_test();
  end
